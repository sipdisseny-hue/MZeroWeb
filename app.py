...
TEXTOS = {
    "es": {
        ...
        "legal_email": "Email: contacto.mzero",
    ...
    "ca": {
        ...
        "legal_email": "Email: contacto.mzero",
        "legal_aviso_texto": "Mzero és el nom comercial sota el qual Joan Carles Ros, presta els serveis oferts mitjançant aquesta aplicació. Aquesta aplicació proporciona funcionalitats de documentació, gestió de cursos, gestió de docents i alumnes i avaluació formativa o professional, segons l’accés utilitzat.",
...
with st.sidebar:
    st.markdown(
        ...
        section[data-testid="stSidebar"] {
            background-color: var(--mz-graphite) !important;
        }
        ...
        section[data-testid="stSidebar"] [data-testid="stCaptionContainer"] {
            color: var(--mz-offwhite) !important;
        }
    ...
    st.markdown(
        '<div style="font-size:22px; font-weight:700; letter-spacing:0.3px; margin: 6px 0 4px;">'
        'M<span style="color: var(--mz-brass-light);">-Zero</span> '
        '<span style="font-weight:400; color:#8B93A0; font-size:16px;">Pro</span>'
        '</div>',
        unsafe_allow_html=True,
    )
    ...
    st.markdown(
        ...
        section[data-testid="stSidebar"] div[data-testid="stButton"] > button {
            ...
            padding-left: 16px;
            margin-bottom: 8px;
            background-color: var(--mz-graphite-2);
            border: 1px solid #2A3340;
            color: var(--mz-offwhite);
        }
        section[data-testid="stSidebar"] div[data-testid="stButton"] > button:hover {
            border-color: var(--mz-brass);
            color: var(--mz-brass-light);
        }
        </style>""",
        unsafe_allow_html=True,
    )
